...
# define BAL 4    // "bal" (le) PD2 lábon   (2)
# define JOBB 16  // "jobb" (fel) PD4 lábon   (4)
# define ALL 8   // "kozep-all" (vissza)  PD3 lábon  (3)
...
void kezdo_beall(void)
{
 ...
 /*  ADC_Init    */
    ...
    ADMUX= 0b01000011;  // Uref: AVCC + AREF-kondi,  ADLAR=0,    ADC3 (PC3)  lesz a bemeneti csatorna,
